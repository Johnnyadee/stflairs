...
<?php 
	...
	$allwithdrawals = getAllWithdrawalTransactions($conn);
...
<html lang="en">
	<head>
		...
		<title>All Withdrawal Transactions</title>
		<meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl  pace-done">
    ...
    <header class="app-header">
		<a style="font-weight:bold" class="app-header__logo" href="index.php">View All Withrwawl Transactions Transaction</a>
...
<main class="app-content">
      <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="#">List of all Withdrawal Transactions</a></li>
        </ul>
      </div>      
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <h3 class="tile-title" style="font-size:14px">List of all Withdrawal Transactions<span class="ml-5" style="font-size:14px"> </h3>
             ...
             <!--<h4 class="text-center">Transaction history</h4>-->
                <div class="table-responsive">
            			<table class="table table-hover table-bordered table-striped" id="refrralTable">
            				...
            				while($row=mysqli_fetch_array($allwithdrawals)){ ?>
            				<tr id="<?php echo $row["id"]; ?>">
								...
								<td>
									<a href="settlewithdrawal.php?withdrawid=<?php echo $row['id'] ?>" class="btn btn-primary" style="color:white; font-weight:bold; text-decoration:none">
									 Settle
									</a>
								</td>
		...
		$(document).ready(function(){
		 ...
		 <script src="paymentlog_files/jquery-3.js"></script>
			...
			<script>
				$('#allwithdrawals').addClass("active");
			</script>
