...
<html lang="en">
	<head>
		...
		<title>Manage Customers Page</title>
		<meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl  pace-done">
    ...
    <header class="app-header">
		<a style="font-weight:bold" class="app-header__logo" href="index.php">Manage Customers</a>
	...
	<main class="app-content">
      <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="#">Nanakhadijat Customer Page</a></li>
        </ul>
      </div>      
	  ...
	  <div class="row">
        <div class="col-md-12">
          <div class="tile">
		 	...
		 	<div class="row m-1">
				<div class="col-lg-6"> <p class="tile-title" style="font-size:14px; font-weight:bold">List of All Customers <span class="ml-5" style="font-size:14px"> </p></div>
				<div class="col-lg-6 text-right"><button class="btn btn-primary addNewCustomerModal" data-toggle="modal" data-target="#addNewCustomerModal"> Add New Customer</button> </div>
			</div>
            				...
            				<tr>
            					...
            					<td> 
									<a href="#updatephotomodal"  data-toggle="modal"> 
										...
										alt="Customer's Images" 
										src="../../images/customerpix/<?php  echo $row['image_url'] ?>" 
										width="80px" height="80px" 
										data-id="<?php echo $row['id'] ?>" /> 
									</a>
								</td>
								<td width="100px">
									<a href="#editCustomerModal" class="" data-toggle="modal">
										<i class="material-icons edit_customer" data-toggle="tooltip" 
										data-id="<?php echo $row["id"]; ?>"
			...
			<div class="modal-content">
				<form id="recordnew_rawmaterialform">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-info" id="recordnew_rawmaterial">Add New Customer</button>
					</div>
			...
			<div class="modal-content">
				<form id="update_customerform">
					...
					<div class="modal-footer">
						...
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
						<button type="button" class="btn btn-info" id="update_customer">Update Customer</button>
					</div>
	...
	<div id="deleteProgrammeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form>	
					<div class="modal-header">						
						<h4 class="modal-title">Delete Customer Image</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					</div>
					<div class="modal-body">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<form method="POST" action="changegallerypix.php" enctype="multipart/form-data">	
					<div class="modal-header">						
						<h4 class="modal-title">Change Customer Image</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					</div>
