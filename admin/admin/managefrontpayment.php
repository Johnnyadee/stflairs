<?php 
    ...
    $upfrontpayments = getAllUpfrontPayments($conn);
...
<html lang="en">
	<head>
		...
		<title>Manage Up-Front Payments</title>
		<meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl  pace-done">
    ...
    <header class="app-header">
		<a style="font-weight:bold" class="app-header__logo" href="index.php">Manage Up-front Payments</a>
	...
	<main class="app-content">
      <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="#">Nanakhadijat Investment Page</a></li>
        </ul>
      </div>      
	  ...
	  <div class="row">
        <div class="col-md-12">
          <div class="tile">
		  <div class="row m-1">
				<div class="col-lg-6"> <p class="tile-title" style="font-size:14px; font-weight:bold">List of All Up-front Payment <span class="ml-5" style="font-size:14px"> </p></div>
				<div class="col-lg-6 text-right"><button class="btn btn-primary addupfrontpayment" data-toggle="modal" data-target="#addNewUpfrontPaymentModal"> Add New Upfront Payment</button> </div>
			</div>
                ...
                <div class="table-responsive">
            			<table class="table table-hover table-bordered table-striped" id="refrralTable">
            				...
            				<tr>
								<?php
									$i =1;
									while($row=mysqli_fetch_array($upfrontpayments)){ 
								?>
								<tr id="<?php echo $row["id"]; ?>">
								<td><?php  echo $row['id'] ?> </td>
            					<td><?php echo getCustomername($conn,$row["id"]) ?></td>
								<td>
            					...
            					<td> 
									<a href="#updatephotomodal"  data-toggle="modal"> 
									 	<img class="avatar round-img rounded-circle update_POP" 
										alt="Proof of payment's Images" 
										src="../../images/pop/<?php  echo getCustomerPOP($conn,$row['id']) ?>" 
								...
								<td width="100px">
									<a href="#editUpfrontPaymentModal" class="" data-toggle="modal">
										<i class="material-icons edit_upfrontpayment" data-toggle="tooltip" 
										data-id="<?php echo $row["id"]; ?>"
										data-customername="<?php echo getCustomerName($conn,$row["id"]); ?>"
                                        data-paymentdescription="<?php echo $row["payment_description"]; ?>"
	...
	<!-- Add Modal HTML -->
	<div id="addNewUpfrontPaymentModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form id="recordnew_upfrontpaymentform">
					<div class="modal-header">						
						<h4 class="modal-title">Add a New Up-front Payment   </h4>
					...
					<div class="modal-body">
                        ...
                        <div class="form-group">
							...
							<input type="text" class="form-control" id="paymentdesc" name="paymentdescription" /> 
						</div>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-info" id="recordnew_upfrontpayment">Add New Upfront Payment</button>
					</div>
	...
	<div id="editUpfrontPaymentModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form id="update_upfrontpaymentform">
					<div class="modal-header">						
						<h4 class="modal-title">Edit Upfront Payment Details </h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					</div>
	...
	<div id="deleteProgrammeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form>	
					<div class="modal-header">						
						<h4 class="modal-title">Delete Proof od Payment Image</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					</div>
					<div class="modal-body">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<form method="POST" action="changegallerypix.php" enctype="multipart/form-data">	
					<div class="modal-header">						
						<h4 class="modal-title">Change Proof Of Payment Image</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					</div>
